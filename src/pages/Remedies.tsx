...
const REMEDIES_LIST = [
  { id: 101, name: 'Rahu-Ketu Shanti Puja', type: 'Ritual/Puja', description: 'Removes doshas, brings stability in career, and cures health disturbances. Done at Trimbakeshwar.', price: 2100, image: 'https://images.unsplash.com/photo-1609137144813-f86af1dfd08c?auto=format&fit=crop&q=80&w=300' },
  { id: 102, name: 'Maha Mrityunjaya Homa', type: 'Ritual/Puja', description: 'Powerful cosmic protection chant for health, longevity, and warding off negative energies.', price: 5100, image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&q=80&w=300' },
  ...
  { id: 104, name: 'Saraswati Yantra', type: 'Spiritual Item', description: 'Sacred copper geometric grid layout supporting intellect, studies, learning clarity, and music.', price: 450, image: 'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?auto=format&fit=crop&q=80&w=300' },
];
...
export const Remedies: React.FC = () => {
  ...
  const handlePurchase = (remedy: any) => {
    // Treat the remedy booking like an astrologer consultation booking
    const simulatedAstrologer = {
      id: remedy.id,
      name: remedy.name,
      specialty: remedy.type,
      pricePerMin: Math.round(remedy.price / 15), // Mock price conversion
      image: remedy.image
    };
