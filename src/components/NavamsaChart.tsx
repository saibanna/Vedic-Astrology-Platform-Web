      ...
      <div style={{
        ...
        <svg viewBox="0 0 400 400" width="100%" height="100%" style={{ overflow: 'visible' }}>
          ...
          <g transform="translate(345, 12)">
            <rect x="0" y="0" width="42" height="22" rx="6" fill="#b8932b" />
            <text x="21" y="12" fill="#ffffff" fontSize="11" fontWeight="bold" textAnchor="middle" dominantBaseline="middle">D-9</text>
          </g>
